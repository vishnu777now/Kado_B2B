			...
			`<div class="kwt-file"><div class="kwt-file__drop-area"><span class='kwt-file__choose-file ${
				...
				element.attributes.data_btn_text
					? "" === element.attributes.data_btn_text.textContent
						...
						: `${element.attributes.data_btn_text.textContent}`
					: `<svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg"> <g clip-path="url(#clip0_7_574)"> <path d="M19.2498 15.7909V18.9159H6.74984V15.7909H4.6665V18.9159C4.6665 20.0617 5.604 20.9992 6.74984 20.9992H19.2498C20.3957 20.9992 21.3332 20.0617 21.3332 18.9159V15.7909H19.2498ZM7.7915 9.54085L9.26025 11.0096L11.9582 8.3221V16.8325H14.0415V8.3221L16.7394 11.0096L18.2082 9.54085L12.9998 4.33252L7.7915 9.54085Z" fill="#FF385C"/> </g> <defs> <clipPath id="clip0_7_574"> <rect width="25" height="25" fill="white" transform="translate(0.5 0.166016)"/> </clipPath> </defs> </svg>`
